...
namespace WebAppAzureAss8.Controllers
{
    public class BookCategoriesController : Controller
    {
        ...
        public BookCategoriesController(Bookstore21DbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.BookCategories != null ? 
                          ...
                          Problem("Entity set 'Bookstore21DbContext.BookCategories'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Bookstore21DbContext.BookCategories'  is null.");
            }
            var bookCategory = await _context.BookCategories.FindAsync(id);
            if (bookCategory != null)
            {
