...
namespace WebAppAzureAss8.Controllers
{
    public class AuthorsController : Controller
    {
        ...
        public AuthorsController(Bookstore21DbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Authors != null ? 
                          ...
                          Problem("Entity set 'Bookstore21DbContext.Authors'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Bookstore21DbContext.Authors'  is null.");
            }
            var author = await _context.Authors.FindAsync(id);
            if (author != null)
            {
